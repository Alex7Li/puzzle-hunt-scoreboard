...
async function makeTables() {
  ...
  for (let [k, team] of Object.entries(teams)) {
    ...
    for (let [eggname, egg] of Object.entries(ordered_eggs)) {
      ...
      if (k == "GMs" && eggname == "Hidden 1" && !egg.finder) {
        ...
        link.innerHTML = "<a className=hidden href=https://defuse.ca/b/DRbUMDTywiTGMbENXSbMyP>Hidden 1</a>";
  ...
  cluePDF.innerHTML = "<a href=https://docs.google.com/document/d/e/2PACX-1vSlXMmcKXjumwmldK2PdoKoe9mROMUF79UnbimsEh-FusTwOTMn9PLgHjn6X_0B1DDwLA_xqHk_PkMW/pub>Clue PDF</a>"
